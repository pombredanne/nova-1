...
service_opts = [
    ...
    cfg.StrOpt('osapi_compute_admin_listen',
               default="0.0.0.0",
               help='IP address for the OpenStack Compute Admin API'),
    cfg.IntOpt('osapi_compute_admin_listen_port',
               default=35359,
               help='port number for the OpenStack Compute Admin API'),
    cfg.IntOpt('osapi_compute_admin_workers',
               help='Number of workers for OpenStack Compute Admin API'),
